 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const he=new Map,Uo=new Map,Ke=new Map;function Bt(e,t){try{e.container.addComponent(t)}catch(n){O.debug(`Component ${t.name} failed to register with FirebaseApp ${e.name}`,n)}}function V(e){const t=e.name;if(Ke.has(t))return O.debug(`There were multiple attempts to register component ${t}.`),!1;Ke.set(t,e);for(const n of he.values())Bt(n,e);for(const n of Uo.values())Bt(n,e);return!0}function et(e,t){const n=e.container.getProvider("heartbeat").getImmediate({optional:!0});return n&&n.triggerHeartbeat(),e.container.getProvider(t)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Fi="firebase-installations-database",yi=1,K="firebase-installations-store";let Me=null;function nt(){return Me||(Me=be(Fi,yi,{upgrade:(e,t)=>{switch(t){case 0:e.createObjectStore(K)}}})),Me}async function xe(e,t){const n=ne(e),o=(await nt()).transaction(K,"readwrite"),s=o.objectStore(K),a=await s.get(n);return await s.put(t,n),await o.done,(!a||a.fid!==t.fid)&&_n(e,t.fid),t}async function jn(e){const t=ne(e),r=(await nt()).transaction(K,"readwrite");await r.objectStore(K).delete(t),await r.done}async function me(e,t){const n=ne(e),o=(await nt()).transaction(K,"readwrite"),s=o.objectStore(K),a=await s.get(n),c=t(a);return c===void 0?await s.delete(n):await s.put(c,n),await o.done,c&&(!a||a.fid!==c.fid)&&_n(e,c.fid),c}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ui="/firebase-messaging-sw.js",Ki="/firebase-cloud-messaging-push-scope",Mn="BDOU99-h67HcA6JeFXHbSNMu7e2yNNu3RzoMj8TM4W88jITfq7ZmPvIM1Iv-4_l2LxQcYwhqby2xGpWwzjfAnG4",Gi="https://fcmregistrations.googleapis.com/v1",Pn="google.c.a.c_id",qi="google.c.a.c_l",Ji="google.c.a.ts",Yi="google.c.a.e",Pt=1e4;var $t;(function(e){e[e.DATA_MESSAGE=1]="DATA_MESSAGE",e[e.DISPLAY_NOTIFICATION=3]="DISPLAY_NOTIFICATION"})($t||($t={}));/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function As(e,t){return $i(t,()=>{(async()=>!e.onRegisteredHandler||!await Hn(e.firebaseDependencies)||await Un(e).catch(()=>{}))()})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Kn(e,t){if(!navigator)throw p.create("only-available-in-window");if(Notification.permission==="default"&&await Notification.requestPermission(),Notification.permission!=="granted")throw p.create("permission-blocked");return await Vn(e,t==null?void 0:t.vapidKey),await Ln(e,t==null?void 0:t.serviceWorkerRegistration),ps(e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Os=e=>{const t=new Bs(e.getProvider("app").getImmediate(),e.getProvider("installations-internal").getImmediate(),e.getProvider("analytics-internal"));return navigator.serviceWorker.addEventListener("message",n=>Ns(t,n)),t._fidChangeUnsubscribe=As(t,e.getProvider("installations").getImmediate()),t},Ms=e=>{const t=e.getProvider("messaging").getImmediate();return{getToken:r=>Kn(t,r),register:r=>Un(t,r)}};function Ps(){V(new z("messaging",Os,"PUBLIC")),V(new z("messaging-internal",Ms,"PRIVATE")),W(Ut,qe),W(Ut,qe,"esm2020")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function zs(e=qo()){return $s().then(t=>{if(!t)throw p.create("unsupported-browser")},t=>{throw p.create("indexed-db-unsupported")}),et(Qe(e),"messaging").getImmediate()}async function Gn(e,t){return e=Qe(e),Kn(e,t)}function Hs(e,t){return e=Qe(e),Ws(e,t)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
