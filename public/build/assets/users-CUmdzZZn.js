 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zr=()=>Hr().__FIREBASE_DEFAULTS__,Lr=()=>{if(typeof process>"u"||typeof At>"u")return;const e=At.__FIREBASE_DEFAULTS__;if(e)return JSON.parse(e)},Vr=()=>{if(typeof document>"u")return;let e;try{e=document.cookie.match(/__FIREBASE_DEFAULTS__=([^;]+)/)}catch{return}const t=e&&Wr(e[1]);return t&&JSON.parse(t)},Kr=()=>{try{return Or()||zr()||Lr()||Vr()}catch(e){console.info(`Unable to get __FIREBASE_DEFAULTS__ due to: ${e}`);return}},dn=()=>{var e;return(e=Kr())==null?void 0:e.config};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Qe(e){return e&&e._delegate?e._delegate:e}class H{constructor(t,n,r){this.name=t,this.instanceFactory=n,this.type=r,this.multipleInstances=!1,this.serviceProps={},this.instantiationMode="LAZY",this.onInstanceCreated=null}setInstantiationMode(t){return this.instantiationMode=t,this}setMultipleInstances(t){return this.multipleInstances=t,this}setServiceProps(t){return this.serviceProps=t,this}setInstanceCreatedCallback(t){return this.onInstanceCreated=t,this}}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Yr{constructor(t,n){this.name=t,this.container=n,this.component=null,this.instances=new Map,this.instancesDeferred=new Map,this.instancesOptions=new Map,this.onInitCallbacks=new Map}get(t){const n=this.normalizeInstanceIdentifier(t);if(!this.instancesDeferred.has(n)){const r=new Ur;if(this.instancesDeferred.set(n,r),this.isInitialized(n)||this.shouldAutoInitialize())try{const o=this.getOrInitializeService({instanceIdentifier:n});o&&r.resolve(o)}catch{}}return this.instancesDeferred.get(n).promise}getImmediate(t){const n=this.normalizeInstanceIdentifier(t==null?void 0:t.identifier),r=(t==null?void 0:t.optional)??!1;if(this.isInitialized(n)||this.shouldAutoInitialize())try{return this.getOrInitializeService({instanceIdentifier:n})}catch(o){if(r)return null;throw o}else{if(r)return null;throw Error(`Service ${this.name} is not available`)}}getComponent(){return this.component}setComponent(t){if(t.name!==this.name)throw Error(`Mismatching Component ${t.name} for Provider ${this.name}.`);if(this.component)throw Error(`Component for ${this.name} has already been provided`);if(this.component=t,!!this.shouldAutoInitialize()){if(Qr(t))try{this.getOrInitializeService({instanceIdentifier:z})}catch{}for(const[n,r]of this.instancesDeferred.entries()){const o=this.normalizeInstanceIdentifier(n);try{const s=this.getOrInitializeService({instanceIdentifier:o});r.resolve(s)}catch{}}}}clearInstance(t=z){this.instancesDeferred.delete(t),this.instancesOptions.delete(t),this.instances.delete(t)}async delete(){const t=Array.from(this.instances.values());await Promise.all([...t.filter(n=>"INTERNAL"in n).map(n=>n.INTERNAL.delete()),...t.filter(n=>"_delete"in n).map(n=>n._delete())])}isComponentSet(){return this.component!=null}isInitialized(t=z){return this.instances.has(t)}getOptions(t=z){return this.instancesOptions.get(t)||{}}initialize(t={}){const{options:n={}}=t,r=this.normalizeInstanceIdentifier(t.instanceIdentifier);if(this.isInitialized(r))throw Error(`${this.name}(${r}) has already been initialized`);if(!this.isComponentSet())throw Error(`Component ${this.name} has not been registered yet`);const o=this.getOrInitializeService({instanceIdentifier:r,options:n});for(const[s,a]of this.instancesDeferred.entries()){const c=this.normalizeInstanceIdentifier(s);r===c&&a.resolve(o)}return o}onInit(t,n){const r=this.normalizeInstanceIdentifier(n),o=this.onInitCallbacks.get(r)??new Set;o.add(t),this.onInitCallbacks.set(r,o);const s=this.instances.get(r);return s&&t(s,r),()=>{o.delete(t)}}invokeOnInitCallbacks(t,n){const r=this.onInitCallbacks.get(n);if(r)for(const o of r)try{o(t,n)}catch{}}getOrInitializeService({instanceIdentifier:t,options:n={}}){let r=this.instances.get(t);if(!r&&this.component&&(r=this.component.instanceFactory(this.container,{instanceIdentifier:Xr(t),options:n}),this.instances.set(t,r),this.instancesOptions.set(t,n),this.invokeOnInitCallbacks(r,t),this.component.onInstanceCreated))try{this.component.onInstanceCreated(this.container,t,r)}catch{}return r||null}normalizeInstanceIdentifier(t=z){return this.component?this.component.multipleInstances?t:z:t}shouldAutoInitialize(){return!!this.component&&this.component.instantiationMode!=="EXPLICIT"}}function Xr(e){return e===z?void 0:e}function Qr(e){return e.instantiationMode==="EAGER"}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const O=new oo("@firebase/app"),mo="@firebase/app-compat",Eo="@firebase/analytics-compat",wo="@firebase/analytics",Fo="@firebase/app-check-compat",yo="@firebase/app-check",So="@firebase/auth",Co="@firebase/auth-compat",Io="@firebase/database",Ao="@firebase/data-connect",vo="@firebase/database-compat",Do="@firebase/functions",_o="@firebase/functions-compat",To="@firebase/installations",ko="@firebase/installations-compat",Bo="@firebase/messaging",jo="@firebase/messaging-compat",Ro="@firebase/performance",No="@firebase/performance-compat",Oo="@firebase/remote-config",Mo="@firebase/remote-config-compat",Po="@firebase/storage",$o="@firebase/storage-compat",Wo="@firebase/firestore",Ho="@firebase/ai",zo="@firebase/firestore-compat",Lo="firebase";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function oi(e){V(new H("platform-logger",t=>new po(t),"PRIVATE")),V(new H("heartbeat",t=>new ei(t),"PRIVATE")),W(Ve,kt,e),W(Ve,kt,"esm2020"),W("fire-js","")}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const On="installations",Hi="installations-internal",zi=e=>{const t=e.getProvider("app").getImmediate(),n=Wi(t),r=et(t,"heartbeat");return{app:t,appConfig:n,heartbeatServiceProvider:r,_delete:()=>Promise.resolve()}},Li=e=>{const t=e.getProvider("app").getImmediate(),n=et(t,On).getImmediate();return{getId:()=>Oi(n),getToken:o=>Mi(n,o)}};function Vi(){V(new H(On,zi,"PUBLIC")),V(new H(Hi,Li,"PRIVATE"))}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function As(e,t){return $i(t,()=>{(async()=>!e.onRegisteredHandler||!await zn(e.firebaseDependencies)||await Kn(e).catch(()=>{}))()})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Hs(e=qo()){return $s().then(t=>{if(!t)throw p.create("unsupported-browser")},t=>{throw p.create("indexed-db-unsupported")}),et(Qe(e),"messaging").getImmediate()}async function Gn(e,t){return e=Qe(e),Un(e,t)}function zs(e,t){return e=Qe(e),Ws(e,t)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */W(Ls,Vs,"app");const Ks={apiKey:"AIzaSyAUjyNbF__Ki6QVYmpviFP9MEddgZxGZIQ",authDomain:"spotlly.firebaseapp.com",projectId:"spotlly",storageBucket:"spotlly.firebasestorage.app",messagingSenderId:"1057323783239",appId:"1:1057323783239:web:c9d2e421f615d9e8e94d62"},Us=gn(Ks);let ge=null;typeof window<"u"&&(ge=Hs(Us));const Gs=T(i.jsx("path",{d:"M18 16v-5c0-3.07-1.64-5.64-4.5-6.32V4c0-.83-.68-1.5-1.51-1.5S10.5 3.17 10.5 4v.68C7.63 5.36 6 7.92 6 11v5l-1.3 1.29c-.63.63-.19 1.71.7 1.71h13.17c.89 0 1.34-1.08.71-1.71zm-6.01 6c1.1 0 2-.9 2-2h-4c0 1.1.89 2 2 2M6.77 4.73c.42-.38.43-1.03.03-1.43-.38-.38-1-.39-1.39-.02C3.7 4.84 2.52 6.96 2.14 9.34c-.09.61.38 1.16 1 1.16.48 0 .9-.35.98-.83.3-1.94 1.26-3.67 2.65-4.94M18.6 3.28c-.4-.37-1.02-.36-1.4.02-.4.4-.38 1.04.03 1.42 1.38 1.27 2.35 3 2.65 4.94.07.48.49.83.98.83.61 0 1.09-.55.99-1.16-.38-2.37-1.55-4.48-3.25-6.05"}));function qs({open:e,onClose:t,uuid:n}){const[r,o]=F.useState(!1),s=async()=>{try{o(!0);const a=await Notification.requestPermission();if(console.log("NOTIFICATION PERMISSION:",a),a!=="granted"){o(!1);return}const c=await navigator.serviceWorker.register("/firebase-messaging-sw.js");console.log("SERVICE WORKER REGISTERED:",c);const u=await Gn(ge,{vapidKey:"BMrlXhCM4FvgLg4dhS1qIRdWG_-0dzrH4p6goE2Gm5vOKP_Tw kWVFmjsv2G-Bts2Jny0NBf0OHMd6OY6MTeLLUw".replace(" ",""),serviceWorkerRegistration:c});if(console.log("FCM TOKEN:",u),!u){console.error("FCM TOKEN WAS NOT GENERATED"),o(!1);return}const d=localStorage.getItem(`ticket_id_${n}`);if(console.log("TICKET ID:",d),d){const h=await ae.post("/api/web/save-fcm-token",{ticket_id:d,fcm_token:u});console.log("FCM TOKEN SAVED:",h.data)}else console.warn("NO TICKET ID FOUND");o(!1),window.location.reload()}catch(a){console.error("FCM ERROR:",a),o(!1)}};return i.jsx(sr,{open:e,disableEscapeKeyDown:!0,onClose:()=>{},children:i.jsxs(ar,{sx:{p:4,textAlign:"center",width:{xs:"calc(100vw - 40px)",sm:420},maxWidth:420},children:[i.jsx(Gs,{sx:{fontSize:80,color:"#0ab7ab",mb:2}}),i.jsx(f,{sx:{fontSize:24,fontWeight:900,mb:1},children:"فعّل الإشعارات"}),i.jsx(f,{sx:{color:"#64748b",lineHeight:2,mb:3},children:"فعّل الإشعارات حتى نتمكن من إعلامك عندما يقترب دورك أو يحين دورك."}),i.jsx(Je,{fullWidth:!0,variant:"contained",disabled:r,onClick:s,sx:{py:1.3,borderRadius:3,fontWeight:800,background:"linear-gradient(90deg,#0ab7ab,#4cc9f0,#9d4edd)","&:hover":{background:"linear-gradient(90deg,#09a99e,#3ebbdc,#8d43c9)"}},children:r?i.jsx(Xt,{size:24,sx:{color:"#fff"}}):"تفعيل الإشعارات"})]})})}function Js(){const{uuid:e}=Jn(),t=Yt(),[n,r]=F.useState(null),[o,s]=F.useState(!1),[a,c]=F.useState(null),[u,d]=F.useState(!1),h=X(gr),x=X(pr),m=X(nn),w=x==null?void 0:x.queueOpen,k=h==null?void 0:h.checking,M=h==null?void 0:h.activeTicket,ce=h==null?void 0:h.status,re=h==null?void 0:h.TUEFF,Se=h==null?void 0:h.currentNumber,Ce=x==null?void 0:x.lastTicketNumber,le=x==null?void 0:x.waitingCount;x==null||x.lastCustomer;const Ie=x==null?void 0:x.lastServedNumber,Ae=h==null?void 0:h.peopleBeforeMe;return F.useEffect(()=>{new Audio("/sounds/ticket-call.mp3").load()},[]),F.useEffect(()=>{Notification.permission!=="granted"&&d(!0)},[]),F.useEffect(()=>{let y=null;return(async()=>{var P;try{const $=await navigator.serviceWorker.register("/firebase-messaging-sw.js");if(console.log("🔥 FCM SERVICE WORKER:",$),Notification.permission!=="granted"){console.log("❌ Notification permission:",Notification.permission);return}const q=await Gn(ge,{vapidKey:"BMrlXhCM4FvgLg4dhS1qIRdWG_-0dzrH4p6goE2Gm5vOKP_TwkWVFmjsv2G-Bts2Jny0NBf0OHMd6OY6MTeLLUw",serviceWorkerRegistration:$});if(!q){console.log("❌ FCM TOKEN NOT FOUND");return}console.log("🔥 CURRENT FCM TOKEN:",q),r(q);const J=localStorage.getItem(`ticket_id_${e}`);if(console.log("🎫 CURRENT TICKET ID:",J),!J)console.log("⏳ No ticket yet");else{const g=await ae.post("/api/web/save-fcm-token",{ticket_id:Number(J),fcm_token:q});console.log("✅ FCM TOKEN SAVED:",g.data)}y=zs(ge,g=>{var at,ct,lt,dt,ut,ft,ht;console.log("🔥🔥 FCM MESSAGE RECEIVED:",g);const S=((at=g==null?void 0:g.notification)==null?void 0:at.title)||((ct=g==null?void 0:g.data)==null?void 0:ct.title)||"Spotlly",C=((lt=g==null?void 0:g.notification)==null?void 0:lt.body)||((dt=g==null?void 0:g.data)==null?void 0:dt.body)||"",Ys=((ut=g==null?void 0:g.notification)==null?void 0:ut.icon)||((ft=g==null?void 0:g.data)==null?void 0:ft.icon)||"/images/slogo.png";if(console.log("🔔 TITLE:",S),console.log("🔔 BODY:",C),Notification.permission==="granted"){const ve=(ht=g==null?void 0:g.data)==null?void 0:ht.type,xt=new Notification(S,{body:C,icon:"/images/slogo.png",badge:"/images/slogo.png",tag:`spotlly-${(g==null?void 0:g.messageId)||Date.now()}`,requireInteraction:!0});let De="/sounds/sound-notification2.mp3";(ve==="turn_called"||ve==="service_started")&&(De="/sounds/sound-notification1.mp3"),console.log("🔊 Notification type:",ve),console.log("🔊 Sound:",De);const gt=new Audio(De);gt.volume=1,gt.play().catch(_e=>{console.log("🔇 SOUND BLOCKED:",_e)}),xt.onclick=()=>{xt.close();const _e=`${window.location.origin}/q/${e}`;window.open(_e,"_blank")}}}),console.log("✅ FCM ONMESSAGE LISTENER READY")}catch($){console.error("❌ FCM INIT ERROR:",((P=$.response)==null?void 0:P.data)||$)}})(),()=>{y&&y()}},[e]),F.useEffect(()=>{if(!(m!=null&&m.id))return;const y=window.Echo.channel(`shop.${m.id}`);return y.listen(".queue.status.changed",E=>{t(Qt({queueOpen:E.queue_open}))}),y.listen(".ticket.created",()=>{Be(t,e)}),y.listen(".ticket.status.changed",E=>{const P=localStorage.getItem(`ticket_uuid_${e}`);P&&E.ticket_uuid===P&&(mt(t,P,e),E.status==="serving"&&(s(!0),Nr())),Be(t,e)}),window.Echo.connector.pusher.connection.bind("connected",()=>{console.log("REVERB CONNECTED")}),window.Echo.connector.pusher.connection.bind("disconnected",()=>{console.log("REVERB DISCONNECTED")}),()=>{window.Echo.leave(`shop.${m.id}`)}},[m==null?void 0:m.id,e]),F.useEffect(()=>{Be(t,e),cr(t,e)},[e,re]),F.useEffect(()=>{const y=localStorage.getItem(`ticket_uuid_${e}`);if(!y){t(Y({checking:!1,activeTicket:!1,status:null,ticketNumber:null,peopleBeforeMe:0}));return}t(Y({checking:!0})),mt(t,y,e)},[e,re]),k?i.jsx("div",{children:i.jsx(bt,{})}):w===null?i.jsx(bt,{}):w?i.jsxs(l,{children:[i.jsx(qs,{open:u,uuid:e,onClose:()=>d(!1)}),ce==="serving"?i.jsx(Rr,{shop:m,ticketNumber:h.ticketNumber,lastCustomer:h==null?void 0:h.customer}):M?i.jsx(jr,{shop:m,currentNumber:Se,peopleBeforeMe:Ae,lastTicketNumber:h.ticketNumber,waitingCount:le,lastCustomer:h==null?void 0:h.customer,lastServedNumber:Ie}):i.jsx(mr,{uuid:e,tUEFF:re,lastTicketNumber:Ce,waitingCount:le,fcmToken:n})]}):i.jsx(l,{sx:{minHeight:"100dvh",display:"flex",alignItems:"center",justifyContent:"center",p:3,background:"linear-gradient(135deg,#743DB1 0%,#47CBE4 50%,#3989EC 100%)"},children:i.jsxs(l,{sx:{width:"100%",maxWidth:500,bgcolor:"#fff",borderRadius:5,p:4,textAlign:"center",boxShadow:"0 25px 60px rgba(0,0,0,.15)"},children:[i.jsx(l,{sx:{width:90,height:100,borderRadius:"50%",bgcolor:"#fee2e2",display:"flex",alignItems:"center",justifyContent:"center",mx:"auto",mb:3},children:i.jsx(l,{sx:{fontSize:40},children:"🔒"})}),i.jsx(l,{sx:{fontSize:28,fontWeight:900,color:"#111827",mb:1},children:"المحل مغلق حالياً"}),i.jsx(l,{sx:{color:"#6b7280",lineHeight:2,fontSize:15},children:"يرجى المحاولة لاحقاً."})]})})}Yn.createRoot(document.getElementById("app")).render(i.jsx(Xn,{store:Qn,children:i.jsx(Zn,{children:i.jsx(er,{children:i.jsx(tr,{path:"/q/:uuid",element:i.jsx(Js,{})})})})}));
